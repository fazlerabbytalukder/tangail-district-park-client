                    ...
                    <div className="col-md-12 mb-5 text-start">
                        <form ref={form} onSubmit={sendEmail} className='all-inputs'>
                            <div className="mb-3">
                                ...
                                <input type="text" name='name' className="form-control from-design w-50" id="exampleFormControlInput1" placeholder="Mr.X" />
                            </div>
                            <div className="mb-3">
                                <label for="exampleFormControlInput1" className="form-label">Your Email</label>
                                <input type="email" name='email' className="form-control from-design w-50" id="exampleFormControlInput2" placeholder="name@example.com" />
                            </div>
                            <div className="mb-3">
