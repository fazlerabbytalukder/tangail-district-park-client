                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav>
                            ...
                            </Nav.Link>
                            {
                                ...
                                <Nav.Link as={Link} to="/home" onClick={logOut} className="btn btn-light rounded-pill px-4 border me-2 ms-2 fw-bold">
                                    Logout
                                </Nav.Link>
                                <Nav.Link as={Link} to="/home" className="btn btn-light rounded-pill px-4 border me-2 ms-2 fw-bold">
                                    {user?.displayName}
                                </Nav.Link>
                                </>
                                    :
